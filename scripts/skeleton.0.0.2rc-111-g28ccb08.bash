...
#
# Interact with bswck/skeleton (current version: https://github.com/bswck/skeleton/tree/0.0.2rc-111-g28ccb08).
#
# This file was generated from bswck/skeleton@0.0.2rc-111-g28ccb08.
# Instead of changing this particular file, you might want to alter the template:
# https://github.com/bswck/skeleton/tree/0.0.2rc-111-g28ccb08/project/scripts/skeleton.%7B%7Bsref%7D%7D.bash.jinja
#
# Usage:
#
...
make_context() {
	...
	SKELETON_REV=$(cat <<- 'EOF'
		https://github.com/bswck/skeleton/tree/0.0.2rc-111-g28ccb08
	EOF
	)
	export SREV
	SREV=$(cat <<- 'EOF'
	...
	SKELETON_AND_REF=$(cat <<- 'EOF'
		bswck/skeleton@0.0.2rc-111-g28ccb08
	EOF
	)
	export SNREF
	SNREF=$(cat <<- 'EOF'
    ...
    export LAST_REF="0.0.2rc-111-g28ccb08"
