...
#
# Interact with bswck/skeleton (current version: https://github.com/bswck/skeleton/tree/030de09).
#
# This file was generated from bswck/skeleton@030de09.
# Instead of changing this particular file, you might want to alter the template:
# https://github.com/bswck/skeleton/tree/030de09/project/scripts/skeleton.%7B%7Bsref%7D%7D.bash.jinja
#
# Usage:
#
...
# Automatically copied from https://github.com/bswck/skeleton/tree/030de09/handle-task-event.sh
# Comms
BOLD="\033[1m"
RED="\033[0;31m"
GREEN="\033[0;32m"
...
ensure_gh_environment() {
    ...
    silent echo "$(jq -n '{"deployment_branch_policy": {"protected_branches": false,"custom_branch_policies": true}}' | gh api -H "Accept: application/vnd.github+json" -X PUT "/repos/bswck/mempip/environments/$1" --input -)" || error 0 "Failed to ensure GitHub environment $BLUE$1$NC exists."
}
